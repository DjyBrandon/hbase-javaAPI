...
module Shell
  ...
  class Shell
    ...
    def help_header
      return "HBase Shell, version #{org.apache.hadoop.hbase.utils.VersionInfo.getVersion()}, " +
             "r#{org.apache.hadoop.hbase.utils.VersionInfo.getRevision()}, " +
             "#{org.apache.hadoop.hbase.utils.VersionInfo.getDate()}" + "\n" +
